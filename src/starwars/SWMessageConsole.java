 ...
 *  
 *  Reference: 
 *  (i) https://tips4java.wordpress.com/2008/11/08/message-console/
 *  (ii) http://www.camick.com/java/source/MessageConsole.java
 *  
...
public class SWMessageConsole
{
	...
	public SWMessageConsole(JTextComponent textComponent)
	{
	 ...
	 */
	public SWMessageConsole(JTextComponent textComponent, boolean isAppend)
	{
...
//	}
	...
	public void setMessageLines(int lines)
	{
		...
		limitLinesListener = new SWLimitLinesDocumentListener(lines, isAppend);
