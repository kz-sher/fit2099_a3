...
public class SWWorld extends World {
	...
	public void initializeWorld(MessageRenderer iface) {
		...
		// Sandcrawler
		Sandcrawler sandcrawler = new Sandcrawler(Team.NEUTRAL, 100, iface, this, patrolmoves);
		entityManager.setLocation(sandcrawler, loc);
		sandcrawler.setSymbol("$");
		
		//test droid
		Droid droid = new Droid("Fakau", 100, iface, this, luke);
		droid.setSymbol("d");
		...
		//Special boss
		BossEntrance e = new BossEntrance(iface, this);
		entityManager.setLocation(e, loc);
		e.setSymbol("E");

		
		// add the gettrainingFrom affordance to ben
		// allow him to train his student (luke) when they meet each other
		ben.addAffordance(new GetTrainingFrom((SWActor) ben, iface, luke));
