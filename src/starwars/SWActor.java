...
public abstract class SWActor extends Actor<SWActionInterface> implements SWEntityInterface {
	...
	/**The force level of this <code>SWActor</code> if he owns the capability of FORCE*/
	...
	/**
	 * Returns the force level of this <code>SWActor</code>.
	 * <p>
	 * Generally, when the game starts, those <code>SWActors</code> who have the FORCE capability will be given 0 force level.
	 * 
	 * @return 	integer
	 */
	...
	/**
	 * This method is literally to increment the force level of the <code>SWActor</code>.
	 * <p>
	 * The use of this method would be associated with <code>GetTrainingFrom</code> class.
	 */
	public void incrementForceLevel(){
		this.forceLevel++;
	}
