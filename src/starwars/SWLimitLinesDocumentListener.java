...
/*
 *  Note: This file is what I get from online resource to redirect console output to my swing application output
 *  
 *  Reference: 
 *  (i) https://tips4java.wordpress.com/2008/10/15/limit-lines-in-document/
 *  (ii) http://www.camick.com/java/source/LimitLinesDocumentListener.java
 *  
 ...
 */
public class SWLimitLinesDocumentListener implements DocumentListener
{
	 ...
	 */
	public SWLimitLinesDocumentListener(int maximumLines)
	{
	 ...
	 */
	public SWLimitLinesDocumentListener(int maximumLines, boolean isRemoveFromStart)
	{
